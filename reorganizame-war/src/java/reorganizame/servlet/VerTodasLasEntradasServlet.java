 ...
 */
@WebServlet(name = "VerTodasLasEntradasServlet", urlPatterns = {"/VerTodasLasEntradasServlet"})
public class VerTodasLasEntradasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = this.getServletContext().getRequestDispatcher("/listaEntradas.jsp");
